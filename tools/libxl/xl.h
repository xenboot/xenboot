...
typedef enum {
	child_console, child_waitdaemon, child_migration, child_vncviewer, child_max
} xlchildnum;

extern __thread xlchild children[child_max];
...
enum output_format {
	OUTPUT_FORMAT_JSON, OUTPUT_FORMAT_SXP,
};
